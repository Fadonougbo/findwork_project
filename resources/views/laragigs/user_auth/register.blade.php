...
@section('main')
    <div class="p-3 ">
        ...
        <section class="w-full flex flex-col text-center my-4 text-laravel" >
            <h2 class="font-bold capitalize text-4xl">Register</h2>
        </section>
        <section class="flex w-full justify-center" >
            <form action=""  method="POST"  class="p-4 bg-gray-300 rounded-2xl flex flex-col w-full ml:w-3/4 items-center md:w-1/2" >
                @csrf
                @include('laragigs.shared.inpute',['label'=>'user name','labelClasse'=>'text-laravel font-semibold','name'=>'name','placeholder'=>'Doe'])
                @include('laragigs.shared.inpute',['label'=>'user email','labelClasse'=>'text-laravel font-semibold','type'=>'email','name'=>'email','placeholder'=>"Exemple:doe@doe.com"])
